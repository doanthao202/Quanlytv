...
namespace A_DAL.Repository
{
    public class NgonnguRepos:INgonnguRepos
    {
        ...
        {
            return _dbContext.Ngonngus.FirstOrDefault(c => c.Id == id);
        }
        ...
        public List<Ngonngu> GetNgonnguByName(string name)
        {
            return _dbContext.Ngonngus.Where(c => c.Tennn.Contains(name)).ToList();
        }
